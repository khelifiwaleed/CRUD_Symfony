 ...
 */
final class Version20220416100219 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog CHANGE contenu contenu VARCHAR(1000) NOT NULL, CHANGE auteur auteur VARCHAR(1000) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog CHANGE contenu contenu VARCHAR(800) NOT NULL, CHANGE auteur auteur VARCHAR(255) NOT NULL');
    }
}
